...
contains(COSMOSCOIN_NEED_QT_PLUGINS, 1) {
    DEFINES += COSMOSCOIN_NEED_QT_PLUGINS
...
HEADERS += src/qt/cosmoscoingui.h \
    ...
    src/qt/cosmoscoinaddressvalidator.h \
    src/alert.h \
    src/addrman.h \
    src/base58.h \
    src/bignum.h \
    ...
    src/qt/cosmoscoinamountfield.h \
    src/wallet.h \
    src/keystore.h \
...
SOURCES += src/qt/cosmoscoin.cpp src/qt/cosmoscoingui.cpp \
    ...
    src/qt/cosmoscoinaddressvalidator.cpp \
    src/alert.cpp \
    src/version.cpp \
    src/sync.cpp \
    src/util.cpp \
    ...
    src/qt/cosmoscoinstrings.cpp \
    src/qt/cosmoscoinamountfield.cpp \
    src/wallet.cpp \
    src/keystore.cpp \
    src/qt/transactionfilterproxy.cpp \
    src/qt/transactionview.cpp \
    src/qt/walletmodel.cpp \
    src/cosmoscoinrpc.cpp \
    src/rpcdump.cpp \
    src/rpcnet.cpp \
    src/rpcmining.cpp \
    src/rpcwallet.cpp \
...
contains(COSMOSCOIN_QT_TEST, 1) {
SOURCES += src/qt/test/test_main.cpp \
    src/qt/test/uritests.cpp
HEADERS += src/qt/test/uritests.h
DEPENDPATH += src/qt/test
QT += testlib
TARGET = CosmosCoin-qt_test
DEFINES += COSMOSCOIN_QT_TEST
}

CODECFORTR = UTF-8

# for lrelease/lupdate
# also add new translations to src/qt/cosmoscoin.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/cosmoscoin_*.ts)
...
OTHER_FILES += \
    doc/*.rst doc/*.txt doc/README README.md res/cosmoscoin-qt.rc src/test/*.cpp src/test/*.h src/qt/test/*.cpp src/qt/test/*.h
...
windows:RC_FILE = src/qt/res/cosmoscoin-qt.rc
...
macx:ICON = src/qt/res/icons/cosmoscoin.icns
macx:TARGET = "CosmosCoin-Qt"
